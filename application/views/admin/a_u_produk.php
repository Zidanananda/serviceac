  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Ubah Jasa Service</h4>
            ...
            <?php foreach ($produk as $p) { ?>
              <form class="forms-sample" action="<?= base_url(); ?>admin/u_produk" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nama_produk" id="nama_produk" placeholder="Nama produk Mie Meleyot" value="<?= $p['nama_produk']; ?>" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  if (isset($p['image'])) { ?>
                    ...
                    <picture>
                      ...
                      <img src="<?= base_url('assets/uploads/Meleyot/') . $p['image']; ?>" class="rounded mx-auto mb-3 d-blok" alt="...">
                    </picture>
